...
Project-specific guidelines for creating consistent Storybook documentation for UI components. These rules ensure all component stories follow the same high-quality pattern and provide clear documentation for developers.
